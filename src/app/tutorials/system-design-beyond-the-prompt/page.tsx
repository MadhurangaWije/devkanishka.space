...
export default function SystemDesignCourseOverviewPage() {
  ...
  const totalLessons = SD_PHASES.reduce((s, p) => s + p.lessons.length, 0);
  ...
  return (
    <div className="px-6 md:px-12 py-12 max-w-3xl">
      ...
      <div className="mb-10">
        <div className="flex flex-wrap items-center gap-3 mb-4">
          ...
          <span className="font-mono text-xs text-text-muted">
            {totalLessons} lessons · {SD_PHASES.length} chapters
          </span>
        </div>
      ...
      <div className="mt-10">
        <Link
          href={`${COURSE_BASE}/${SD_PHASES[0].urlSegment}/${SD_PHASES[0].lessons[0].slug}`}
