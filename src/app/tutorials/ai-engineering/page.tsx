...
export default function AiEngineeringCourseOverviewPage() {
  ...
  const totalLessons = AI_ENGINEERING_PHASES.reduce((s, p) => s + p.lessons.length, 0);
  ...
  return (
    <div className="px-6 md:px-12 py-12 max-w-3xl">
      ...
      <div className="mb-10">
        <div className="flex flex-wrap items-center gap-3 mb-4">
          ...
          <span className="font-mono text-xs text-text-muted">
            {totalLessons} lessons · {AI_ENGINEERING_PHASES.length} modules
          </span>
        </div>
      ...
      <div className="space-y-10">
        {AI_ENGINEERING_PHASES.map((phase) => (
      ...
      <div className="mt-10">
        <Link
          href={`${COURSE_BASE}/${AI_ENGINEERING_PHASES[0].urlSegment}/${AI_ENGINEERING_PHASES[0].lessons[0].slug}`}
