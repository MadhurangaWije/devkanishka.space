...
export const metadata = {
  ...
  description: 'A complete path to AZ-305 and professional architect skills — 50 lessons across 8 phases covering governance, networking, compute, data, security, reliability, and advanced architecture patterns, with case studies and a capstone.',
};
...
export default function AzureArchitectCourseOverviewPage() {
  ...
  const totalLessons = AZURE_ARCHITECT_PHASES.reduce((s, p) => s + p.lessons.length, 0);
  ...
  return (
    <div className="px-6 md:px-12 py-12 max-w-3xl">
      ...
      <div className="mb-10">
        <div className="flex flex-wrap items-center gap-3 mb-4">
          ...
          <span className="font-mono text-xs text-text-muted">
            {totalLessons} lessons · {AZURE_ARCHITECT_PHASES.length} phases
          </span>
        </div>
      ...
      <div className="space-y-10">
        {AZURE_ARCHITECT_PHASES.map((phase) => (
      ...
      <div className="mt-10">
        <Link
          href={`${COURSE_BASE}/${AZURE_ARCHITECT_PHASES[0].urlSegment}/${AZURE_ARCHITECT_PHASES[0].lessons[0].slug}`}
