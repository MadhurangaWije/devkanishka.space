...
const STATIC_COURSE_SLUGS = ['backend-engineering-with-nodejs', 'ml-and-dl-mastery', 'azure-administration', 'python-from-a-to-z', 'system-design-beyond-the-prompt', 'docker-fundamentals', 'ai-engineering', 'cicd-pipelines-with-github-actions', 'azure-solutions-architect', 'kubernetes-mastery'];
