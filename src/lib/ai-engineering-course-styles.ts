...
.ai-engineering-lesson-host strong { font-weight: 600; }
...
.ai-engineering-lesson-bottom-nav-inner { max-width: 700px; margin: 0 auto; padding: 24px 32px; display: flex; justify-content: space-between; gap: 16px; flex-wrap: wrap; }
