...
export const ML_PHASES: PhaseMeta[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: 'gaussian-mixture-models-em', title: 'Gaussian Mixture Models & the EM Algorithm', subtitle: 'K-Means forces every cluster to be round and every point into exactly one group. GMM replaces both assumptions with probability — soft, elliptical clusters fit by the algorithm that also trains HMMs, missing-data imputers, and half of classical statistics.', number: 30, file: '0030-gaussian-mixture-models-em.html' },
      { slug: 'pca', title: 'Principal Component Analysis (PCA)', subtitle: 'How to compress 100 correlated features into 10 uncorrelated ones without losing the information that matters — the most important dimensionality reduction tool in the ML toolkit.', number: 31, file: '0031-pca.html' },
      { slug: 'tsne-umap', title: 't-SNE & UMAP: Visualizing High-Dimensional Data', subtitle: 'When PCA\'s linear lens isn\'t enough — the two dominant non-linear dimensionality reduction tools that reveal cluster structure invisible to any linear method, and the critical pitfalls of misreading their outputs.', number: 32, file: '0032-tsne-umap.html' },
      { slug: 'anomaly-detection', title: 'Anomaly Detection', subtitle: 'Finding the needle in the haystack — statistical methods, Isolation Forest, LOF, and One-Class SVM for detecting fraud, faults, and intrusions without labelled data.', number: 33, file: '0033-anomaly-detection.html' },
      { slug: 'recommendation-systems', title: 'Recommendation Systems & Collaborative Filtering', subtitle: 'How Netflix knows what you want to watch, Amazon knows what you want to buy, and Spotify knows what song comes next — from cosine similarity to matrix factorization.', number: 34, file: '0034-recommendation-systems.html' },
      { slug: 'time-series-analysis', title: 'Time Series Analysis: Trends, Seasonality & Decomposition', subtitle: 'How to read the story hidden in sequential data — decomposing time series into trend, season, and noise components before any forecasting begins.', number: 35, file: '0035-time-series-analysis.html' },
      { slug: 'time-series-forecasting', title: 'Time Series Forecasting: ARIMA, Prophet & LSTM', subtitle: 'From classical ARIMA models to Facebook\'s Prophet and neural sequence models — building forecasters that generate actionable predictions with confidence intervals.', number: 36, file: '0036-time-series-forecasting.html' },
    ],
  },
  {
    number: 4,
    ...
    contentDir: 'ml-mastery',
    lessons: [
      { slug: 'dl-vs-ml', title: 'DL vs ML: When to Use What — Architectures & Tooling', subtitle: 'Before writing a single line of deep learning code, understand when deep learning is the right tool — and when classical ML is still better. Every professional ML engineer knows this boundary intimately.', number: 37, file: '0037-dl-vs-ml.html' },
      { slug: 'neural-network-intuition', title: 'Neural Network Intuition: Neurons, Perceptrons & Activation Functions', subtitle: 'Understanding one artificial neuron unlocks everything else. We build from a single weighted sum all the way to the universal approximation theorem — with NumPy code at every step.', number: 38, file: '0038-neural-network-intuition.html' },
      { slug: 'pytorch-tensors-autograd', title: 'PyTorch Tensors & Autograd: The Engine of Deep Learning', subtitle: 'Master PyTorch tensors — the GPU-capable, gradient-tracking cousin of NumPy arrays — and understand the autograd system that makes automatic differentiation possible. Everything in PyTorch deep learning is built on these foundations.', number: 39, file: '0039-pytorch-tensors-autograd.html' },
      { slug: 'backpropagation', title: 'Backpropagation: The Chain Rule in Action', subtitle: 'The algorithm that made modern deep learning possible. We derive it from first principles, implement it manually in NumPy for a 2-layer network, then verify every gradient against PyTorch\'s automatic differentiation — and finally use it to solve XOR.', number: 40, file: '0040-backpropagation.html' },
      { slug: 'gradient-descent-variants', title: 'Gradient Descent Variants: Batch GD, Mini-Batch & SGD', subtitle: 'How much of the training data should you look at before taking each optimization step? The answer determines whether your model trains in minutes or hours — and whether it generalises well or gets stuck.', number: 41, file: '0041-gradient-descent-variants.html' },
      { slug: 'pytorch-datasets-dataloaders', title: 'PyTorch in Practice: Datasets, DataLoaders & the Training Loop', subtitle: 'The complete infrastructure of PyTorch model training — from loading one sample to orchestrating GPU-accelerated mini-batch training with the canonical training loop.', number: 42, file: '0042-pytorch-datasets-dataloaders.html' },
      { slug: 'optimizers', title: 'Optimizers: EWMA, Momentum, RMSProp & Adam', subtitle: 'Why plain gradient descent stalls on real neural networks — and how modern optimizers solve this with momentum, adaptive learning rates, and their clever combination in Adam.', number: 43, file: '0043-optimizers.html' },
      { slug: 'dl-regularization', title: 'Regularization in DL: Dropout, Batch Normalization & Early Stopping', subtitle: 'Deep networks can memorise entire training datasets. These three techniques are the guardrails that force a model to learn genuine patterns rather than memorising — each attacking overfitting from a completely different angle.', number: 44, file: '0044-dl-regularization.html' },
      { slug: 'cnn-fundamentals', title: 'Convolutional Neural Networks: Convolution, Kernels, Pooling, Padding & Strides', subtitle: 'MLPs are blind to spatial structure — a CNN is engineered to see it. Learn how local connections, weight sharing, and hierarchical feature learning turn pixels into understanding.', number: 45, file: '0045-cnn-fundamentals.html' },
      { slug: 'cnn-practice', title: 'CNNs in Practice: CIFAR-10 Classification & Data Augmentation', subtitle: 'Theory meets reality — build a CNN from scratch on CIFAR-10, learn why data augmentation is one of the most powerful tricks in vision, and understand how BatchNorm stabilises training.', number: 46, file: '0046-cnn-practice.html' },
      { slug: 'transfer-learning', title: 'Transfer Learning: ResNet, EfficientNet & MobileNet', subtitle: 'The single most practical skill in computer vision — take a model pre-trained on millions of images and adapt it to your task in hours with a fraction of the data.', number: 47, file: '0047-transfer-learning.html' },
      { slug: 'sequence-models-rnn-lstm-gru', title: 'Sequence Models: RNN Types, Vanishing Gradient, LSTM & GRU', subtitle: 'Neural networks with memory — understand how RNNs, LSTMs, and GRUs process sequential data, why vanilla RNNs fail on long sequences, and how gated architectures solve the problem.', number: 48, file: '0048-sequence-models-rnn-lstm-gru.html' },
    ],
  },
  {
    number: 5,
    ...
    contentDir: 'ml-mastery',
    lessons: [
      { slug: 'nlp-fundamentals', title: 'NLP Fundamentals: Text Preprocessing, Tokenization & TF-IDF', subtitle: 'Before any neural network can read text, that text must become numbers. Learn the full preprocessing pipeline — from raw strings to cleaned tokens to TF-IDF vectors — and understand exactly why every step exists.', number: 49, file: '0049-nlp-fundamentals.html' },
      { slug: 'word-embeddings', title: 'Word Embeddings: Word2Vec, GloVe & Contextual Embeddings', subtitle: 'Dense vector representations that encode semantic relationships — learn how Word2Vec learns that king−man+woman≈queen, how GloVe uses global statistics, and why static embeddings ultimately need to become contextual.', number: 50, file: '0050-word-embeddings.html' },
      { slug: 'seq2seq-encoder-decoder', title: 'Sequence-to-Sequence: Encoder-Decoder Architecture', subtitle: 'How neural networks translate, summarise, and generate text — understand the encoder-decoder framework, teacher forcing, beam search, and why the information bottleneck problem directly motivated the Attention mechanism.', number: 51, file: '0051-seq2seq-encoder-decoder.html' },
      { slug: 'attention-mechanism', title: 'Attention Mechanism: Queries, Keys & Values', subtitle: 'The single insight that transformed NLP — learn how attention lets networks focus on what matters, the elegant Query-Key-Value formulation, self-attention, multi-head attention, and why this leads directly to the Transformer.', number: 52, file: '0052-attention-mechanism.html' },
      { slug: 'transformer-architecture', title: 'The Transformer Architecture: Positional Embeddings & Multi-Head Attention', subtitle: 'The architecture behind ChatGPT, Claude, Gemini, GitHub Copilot, and AlphaFold — every component explained from first principles, with the "why" behind every design decision.', number: 53, file: '0053-transformer-architecture.html' },
      { slug: 'huggingface-bert', title: 'Hugging Face & BERT: Transformers in Practice + Spam Classification', subtitle: 'Load a state-of-the-art language model in one line, understand exactly what happens inside the tokenizer, and fine-tune BERT to build a spam classifier that beats anything you could train from scratch.', number: 54, file: '0054-huggingface-bert.html' },
      { slug: 'huggingface-gpt2', title: 'Hugging Face & GPT-2: Generative Language Models & Next-Word Prediction', subtitle: 'From next-word prediction to writing essays, code, and stories — understand how GPT-2 generates text, what temperature and sampling strategies control, and how to fine-tune for custom generation tasks.', number: 55, file: '0055-huggingface-gpt2.html' },
      { slug: 'llm-finetuning-lora-peft', title: 'Fine-Tuning LLMs with LoRA & PEFT', subtitle: 'Fine-tune a 7-billion-parameter model on a single consumer GPU — how LoRA achieves full fine-tuning quality by training just 0.06% of parameters, and how QLoRA puts this within reach of anyone with an RTX 3080.', number: 56, file: '0056-llm-finetuning-lora-peft.html' },
      { slug: 'object-detection-segmentation', title: 'Object Detection & Semantic Segmentation', subtitle: 'From "is there a cat?" to "exactly which pixels are the cat" — the complete hierarchy of computer vision tasks powering self-driving cars, medical imaging, and augmented reality.', number: 57, file: '0057-object-detection-segmentation.html' },
      { slug: 'autoencoders', title: 'Autoencoders: From PCA to Generative Latent Spaces', subtitle: 'A neural network trained to reproduce its own input, forced through a narrow bottleneck — the simplest possible generative architecture, and the direct bridge from PCA\'s linear compression to the latent spaces that power GANs and diffusion models.', number: 58, file: '0058-autoencoders.html' },
      { slug: 'gans', title: 'Generative Adversarial Networks (GANs)', subtitle: 'Two neural networks in competitive training — one forger, one detective — whose adversarial competition produces strikingly realistic synthetic images, data augmentation, and creative AI outputs.', number: 59, file: '0059-gans.html' },
      { slug: 'diffusion-models', title: 'Diffusion Models: How DALL·E & Stable Diffusion Work', subtitle: 'From pure noise to photorealistic images — the mathematics and engineering behind the most powerful generative AI systems of our era.', number: 60, file: '0060-diffusion-models.html' },
      { slug: 'rag', title: 'Retrieval-Augmented Generation (RAG)', subtitle: 'Give your LLM a memory and a library — solving hallucination, knowledge cutoffs, and private data access with a combination of vector search and language generation.', number: 61, file: '0061-rag.html' },
      { slug: 'multimodal-models', title: 'Multimodal Models: Vision-Language & Audio', subtitle: 'AI systems that see, hear, and read simultaneously — the frontier of foundation models, from CLIP and LLaVA to Whisper and the unified models reshaping how AI interacts with the real world.', number: 62, file: '0062-multimodal-models.html' },
    ],
  },
  {
    number: 6,
    ...
    contentDir: 'ml-mastery',
    lessons: [
      { slug: 'optuna-bayesian-search', title: 'Advanced Hyperparameter Tuning: Optuna & Bayesian Search', subtitle: 'Stop searching blindly — use the results of every trial to decide what to try next. Bayesian optimisation, Optuna\'s TPE sampler and pruners, multi-objective tuning, and production-grade integration with scikit-learn and PyTorch.', number: 63, file: '0063-optuna-bayesian-search.html' },
      { slug: 'shap-lime', title: 'Model Interpretability: SHAP & LIME', subtitle: 'Prying open the black box — game-theoretic and surrogate-model techniques for explaining exactly why your model made a specific prediction, to regulators, stakeholders, and yourself.', number: 64, file: '0064-shap-lime.html' },
      { slug: 'mlflow', title: 'MLflow: Experiment Tracking, Model Registry & Centralized Server', subtitle: 'Stop tracking hyperparameters in spreadsheets and model files in folders named "final_v3_REAL" — MLflow gives every experiment, model, and deployment decision a permanent, queryable, team-visible record.', number: 65, file: '0065-mlflow.html' },
      { slug: 'fastapi-docker-deployment', title: 'Deploying ML Models: FastAPI, Docker & REST APIs', subtitle: 'Turn a trained model sitting in a pickle file or the MLflow Model Registry into a versioned, validated, containerised REST API that other services can actually call in production.', number: 66, file: '0066-fastapi-docker-deployment.html' },
      { slug: 'aws-sagemaker', title: 'Cloud ML: AWS SageMaker & Managed Deployment', subtitle: 'When self-managed Docker deployments stop scaling — how a managed ML platform takes over training infrastructure, model versioning, endpoint scaling, and monitoring, and what that convenience costs.', number: 67, file: '0067-aws-sagemaker.html' },
      { slug: 'data-drift-psi-csi', title: 'Monitoring in Production: Data Drift with PSI & CSI', subtitle: 'Your model\'s accuracy was great at training time — but the world keeps moving. Learn to detect silent distribution shift before it silently wrecks your predictions, using the same two statistics that risk teams have trusted for decades.', number: 68, file: '0068-data-drift-psi-csi.html' },
      { slug: 'ab-testing', title: 'A/B Testing for ML Systems', subtitle: 'Your monitoring caught the drift, your new model is deployed and ready — but "better offline" is a hypothesis, not a fact. A/B testing is how you prove it, safely, with statistics instead of vibes.', number: 69, file: '0069-ab-testing.html' },
    ],
  },
];
